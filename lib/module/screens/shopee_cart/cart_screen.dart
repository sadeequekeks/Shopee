      ...
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
                                    ...
                                    builder: (BuildContext context) =>
                                        AlertDialog(
                                          ...
                                          actions: <Widget>[
                                            ...
                                            TextButton(
                                              onPressed: () async {
                                                await si.cartService.deleteCart(
                                                    itemId: item.id);
                                                cartState.deleteFromCart(item);
            ...
            //     future: si.cartService.getAllCart(userID: userObj.user.id),
            ...
            //                               child: Image(
            //                                 image: NetworkImage(
            //                                   'https://shoppeefy.herokuapp.com${cart.cartItemImage}',
            //                                 ),
            //                               ),
            //                             ),
            //                             const SizedBox(
